            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-6">
                        ...
                        <div
                            class="w-20 h-20 bg-gradient-to-br from-purple-500 to-blue-600 rounded-2xl flex items-center justify-center text-2xl font-bold">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button
                            class="px-6 py-3 bg-red-600 hover:bg-red-500 text-white text-xs uppercase font-bold rounded-xl transition">
                            Logout
                        </button>
                    </form>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="grid grid-cols-3 gap-6">
                        ...
                        <div
                            class="bg-slate-900/60 border border-white/10 p-6 rounded-2xl hover:border-purple-500 transition">
                    ...
                    <div class="bg-slate-900/60 border border-white/10 p-8 rounded-2xl">
                        ...
                        <form action="{{ route('profile.update') }}" method="POST" class="space-y-4">
                            ...
                            <button
                                class="w-full py-4 bg-gradient-to-r from-purple-600 to-blue-600 hover:opacity-90 text-white font-bold uppercase text-xs rounded-xl">
                                Save Changes
                            </button>
                    ...
                    <div class="bg-slate-900/60 border border-white/10 p-6 rounded-2xl">
                        ...
                        <div class="space-y-3">
                            ...
                            @foreach (Auth::user()->games as $game)
                                <div
                                    class="flex items-center gap-4 bg-slate-950 p-3 rounded-xl border border-white/5 hover:border-purple-500 transition">

                                    <img src="{{ $game->image }}" class="w-14 h-10 object-cover rounded">
    ...
    <div id="gameModal" class="fixed inset-0 hidden items-center justify-center bg-black/80 z-50">
        ...
        <div class="bg-slate-900 p-6 w-full max-w-xl border border-white/10 rounded-2xl">
            ...
            <form action="{{ route('profile.games') }}" method="POST">
                ...
                <div class="grid grid-cols-2 gap-4 max-h-96 overflow-y-auto">
                    ...
                    @foreach ($games as $game)
                        <label class="cursor-pointer">
                            ...
                            <input type="checkbox" name="games[]" value="{{ $game->id }}" class="hidden peer"
                                {{ Auth::user()->games->contains($game->id) ? 'checked' : '' }}>

                            <div
                                class="border border-white/10 peer-checked:border-purple-600 rounded-xl overflow-hidden hover:scale-105 transition">

                                <img src="{{ $game->image }}" class="w-full h-28 object-cover">
                ...
                <button
                    class="mt-4 w-full bg-gradient-to-r from-purple-600 to-blue-600 py-3 text-white uppercase text-xs rounded-xl">
                    Confirm
                </button>
