                ...
                @auth
                    @if (auth()->id() === $tournament->organizer_id && $tournament->status === 'pending')
                        <div class="mt-6">
                            ...
                            <form method="POST" action="{{ route('tournois.start', $tournament) }}">
                                @csrf
...
rounded-lg text-sm font-bold uppercase">
    ...
    @elseif ($tournament->status === 'live')
        <p class="text-green-500">Tournament started already !</p>
    </div>
    @endif
                ...
                @forelse($tournament->teams as $team)
                    <a href="{{ route('teams.show', $team) }}"
                        ...
                        <div class="relative flex items-center gap-4">
                            ...
                            <div
                                class="w-14 h-14 rounded-full bg-gradient-to-br from-purple-500 to-blue-600 flex items-center justify-center font-bold">
